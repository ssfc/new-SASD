...
parser.add_argument('--feature_loss_coefficient', default=0.1, type=float)
...
logdir = os.path.join(args.saveroot, args.dataset+'_'+args.model, 'temp_'+ str(args.temp)+'_lamda_'+str(args.lamda))
...
def train(epoch, module_list):
    ...
    for batch_idx, (inputs, labels) in enumerate(trainloader):
        ...
        progress_bar(batch_idx, len(trainloader),
                     ...
                     % (train_loss/(batch_idx+1), 100.*correct/total, correct, total, train_kd_loss/(batch_idx+1)))
